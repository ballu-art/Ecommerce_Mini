...
testimonials = [
  { tag: 'Tile Adhesive',   initial: 'C', name: 'Contractor',    role: 'Construction Professional', text: 'We have been using Balluart tile adhesives for multiple projects, and the bonding strength is outstanding. Easy to apply and highly reliable.' },
  { tag: 'Waterproofing',   initial: 'B', name: 'Builder',       role: 'Civil Construction',        text: 'Balluart products have consistently delivered great results. Their waterproofing solutions are especially effective and long-lasting.' },
  ...
  { tag: 'Value for Money', initial: 'D', name: 'Dealer',        role: 'Building Materials',        text: 'High-quality products at competitive pricing. We prefer Balluart for most of our construction needs.' },
